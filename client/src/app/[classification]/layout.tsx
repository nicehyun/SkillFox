  ...
  return (
    <>
      ...
      <AnlaysisNavigationProvider>
        <div
          className={`${showNavigationState ? "sm:pt-[240px] md:pt-[240px] lg:pl-[288px] xl:pl-[288px]" : "sm:pt-[20px] md:pt-[20px] lg:pl-20 xl:pl-20"} px-4 pr-10 transition-all duration-300 ease-in-out`}
        >
          {children}
        </div>
      </AnlaysisNavigationProvider>
